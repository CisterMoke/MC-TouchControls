...
public class TUIOTouchDriver extends net.tschrock.minecraft.touchmanager.GenericTouchDriver implements TUIO.TuioListener
{
  ...
  public boolean hasGlobalFocus() { return true; }
  ...
  public void addTuioCursor(TuioCursor tCursor)
  {
    ...
    onNewEvent(new TouchEvent(TouchEvent.Type.TOUCH_START, tCursor.getCursorID(), tCursor.getScreenX(width), tCursor.getScreenY(height)));
  }
  ...
  public void removeTuioCursor(TuioCursor tCursor)
  {
    ...
    int width = (int)screenSize.getWidth();
    int height = (int)screenSize.getHeight();
    onNewEvent(new TouchEvent(TouchEvent.Type.TOUCH_END, tCursor.getCursorID(), tCursor.getScreenX(width), tCursor.getScreenY(height)));
  }
  ...
  public void updateTuioCursor(TuioCursor tCursor)
  {
    ...
    int width = (int)screenSize.getWidth();
    int height = (int)screenSize.getHeight();
    onNewEvent(new TouchEvent(TouchEvent.Type.TOUCH_UPDATE, tCursor.getCursorID(), tCursor.getScreenX(width), tCursor.getScreenY(height)));
  }
