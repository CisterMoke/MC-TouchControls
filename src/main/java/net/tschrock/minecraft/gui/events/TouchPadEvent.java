...
public class TouchPadEvent {
  ...
  public TouchPadEvent(MCGuiTouchPad touchPad, net.tschrock.minecraft.gui.touch.TrackedTouchEvent touchEvent, Type type) { this.touchPad = touchPad;
    this.touchEvent = touchEvent;
    this.type = type;
  }
  
  public static enum Type { TAP,  HOLD_START,  HOLD_END,  DRAG_START,  DRAG_UPDATE,  DRAG_END;
