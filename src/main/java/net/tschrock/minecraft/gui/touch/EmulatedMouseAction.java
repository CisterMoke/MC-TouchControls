...
public class EmulatedMouseAction {
    ...
    public EmulatedMouseAction(net.tschrock.minecraft.touchmanager.TouchEvent startTouchEvent, Long startTime,
            MCGuiComponent startComponent, MCGuiComponent overComponent) {
